...
//CODE HERE
const problem1Greeting = "Hello, World!";

function helloWorld() {
  console.log(problem1Greeting);
}
...
const problem2Greeting = "I am a JavaScript ninja!";

const jsNinja = (logThis) => console.log(logThis);

jsNinja(problem2Greeting);
...
console.log(compareNums(4, 72));

const compareNums2 = (number1, number2) =>
  number1 > number2 ? number1 : number2;

console.log(compareNums2(4, 72));
...
function add(number1, number2) {
  ...
  let convertedNumber2 = Number(number2);
...
function faveColourFinder(colour) {
  switch (colour) {
    case "red":
      return "red is a great colour";
      break;
    case "green":
      return "green is a solid favorite colour";
      break;
    case "black":
      return "so trendy";
      break;
    default:
      return "you need to evaluate your favorite colour choice";
  }
}

let colourChoice = "purple";
let colourRating = faveColourFinder(colourChoice);
...
const thatsOdd = (testNumber) =>
  testNumber % 2 === 0 ? "That's not odd!" : "That is odd indeed";
...
console.log(bestMovie("Oblivion"));
...
function bigOrSmall(arrayOfNumbers) {
  ...
  for (let i = 0; i < arrayOfNumbers.length; i++) {
    arrayOfNumbers[i] > 100 ? answers.push("big") : answers.push("small");
  }
...
function purchaseChocolateFrogs(gold) {
  return Math.floor(gold / frogPrice);
}

let totalFrogs = purchaseChocolateFrogs(budget);
...
function isThisAscending(testArray) {
  let isAscending = true;

  for (let i = 0; i < testArray.length - 1; i++) {
    if (testArray[i] > testArray[i + 1]) {
      console.log(`${testArray[i]} > ${testArray[i + 1]}`);
      isAscending = false;
    }
  }
